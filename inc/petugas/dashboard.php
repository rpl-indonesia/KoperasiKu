<?php 
  ...
  $Count_Anggota_Aktif = $run->CountData('anggota where flag = 1 order by id_anggota asc');
  $Count_Anggota_NonAktif = $run->CountData('anggota where flag = 0 order by id_anggota asc');
    ...
    <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
      <div class="panel panel-teal panel-widget border-right">
        <div class="row no-padding"><em class="fa fa-xl fa-credit-card-alt" color-blue"></em>
          <div class="large" style="font-size: 28px">Rp. 5.000.000,-</div>
    ...
    <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
      <div class="panel panel-orange panel-widget border-right">
        <div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
          <div class="large"><?=$Count_Anggota_Aktif?></div>
          <div class="text-muted">Jumlah Anggota Aktif</div>
        </div>
      </div>
    </div>
    <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
      <div class="panel panel-orange panel-widget border-right">
        <div class="row no-padding"><em class="fa fa-xl fa-users color-red"></em>
          <div class="large"><?=$Count_Anggota_NonAktif?></div>
          <div class="text-muted">Jumlah Anggota Non-Aktif</div>
        </div>
      </div>
    </div>
  </div><!--/.row-->
...
<?php
  if (!empty($run->getSes('success'))) {
?>

<div class="dialog" id="success"><?=$run->getSes('success')?></div>
<script>
  setTimeout(function(){
